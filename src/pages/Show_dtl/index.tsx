...
// export default class IShowdtls extends Component<{}, IState> {
export default class ShowDetail extends Component<{}, IState> {
  [x: string]: any;
  public state: IState = {
    details: [],
    transaction: [],
  ...
  public createDetail(input: IShowdtl) {
    this.setState({ loading: true })
    this.detailService
      .create(input)
      .then(() => this.getDetail())
  ...
  public updateDetail(input: IShowdtl, id: string) {
    this.setState({ loading: true })
    this.detailService
      .update(input, id)
      .then(() => this.getDetail())
